...
- **Dual Model Classification**
  ...
  - Style Model: 92% accuracy (classifies broader styles like ethnic, casual, classic, etc.)
...
- GitHub: [Prashant-sharma-8J]

---

## ⭐ Show Your Support

If you found this project helpful, please give it a ⭐ on GitHub and upvote the dataset on Kaggle!


---

**Made with ❤️ using ResNet50, FastAPI, and modern web technologies**
